...
const About = () => {
  return (
      <Box>
      <AboutContainer>
      <AboutText>Winchmore Hill Local.Life is part of the <AboutLink href="https://www.lovelocal.life/">LoveLocal.Life</AboutLink> project.  Check out the <AboutLink href="https://www.brixtonlocal.life/">Brixton</AboutLink>, <AboutLink href="https://www.lewishamlocal.life/">Lewisham</AboutLink>, <AboutLink href="https://www.sydenhamlocal.life/">Sydenham</AboutLink> and <AboutLink href="https://www.wokinghamlocal.life/">Wokingham</AboutLink> sites!</AboutText>  
      <AboutText>Amba Horton coordinated the entries for Winchmore Hill.</AboutText>
      <AboutText>The information on this website is crowd-sourced using a Google spreadsheet. To add an entry or update/remove an existing one please email <AboutLink href = "mailto: amba.horton@yahoo.co.uk">Amba</AboutLink>.</AboutText>
